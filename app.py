...
st.markdown("<h1 style='text-align: center; color: #0056b3;'>Engro Energy: Thar Block II Command Center</h1>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center; color: gray;'>Strategic ESG, Grid Telemetry & Infrastructure Deployment Dashboard</p>", unsafe_allow_html=True)
st.divider()
...
with tab1:
    st.markdown("### 🗺️ Engro EPTL: Block II Intervention Map")
    st.write("Spatial analysis for Reverse Osmosis (RO) plants and Solar Microgrid deployments based on localized scarcity indices.")
